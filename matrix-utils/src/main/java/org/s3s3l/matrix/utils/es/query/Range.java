package org.s3s3l.matrix.utils.es.query;

import java.util.HashMap;
import java.util.Map;

import org.s3s3l.matrix.utils.es.query.builder.RangeFieldBuilder;
import org.s3s3l.matrix.utils.es.query.builder.RangeFieldCreator;
...
public class Range implements QueryBlock {
    ...
    public String toQueryString() {
        return String.format("{\"range\": %s}", JacksonUtils.NON_NULL.toStructuralString(fields));
    }
